...
class _HomePageState extends State<HomePage> {
          ...
          return BottomSheet(
              builder: (context){
                return Container(
                  padding: EdgeInsets.all(10.0),
                  child: Column(
                    mainAxisSize: MainAxisSize.min, // para ocupar o minimo de espaco possivel
                    children: <Widget>[
                     Padding(
                        padding: EdgeInsets.all(10.0),
                        child: FlatButton(
                     ...
                     Padding(
                       ...
                       child: FlatButton(
                         ...
                         onPressed: (){
                           Navigator.pop(context);// fecha os option menu
                     ...
                     Padding(
                       ...
                       child: FlatButton(
                         ...
                         onPressed: (){
                            contactHelper.delteContact(contacts[index].id);
                            setState(() {
  ...
  void _showContactPage({Contact contact}) async {
    final recContact = // a tela devolve o objeto
